			...
			<div class="input-group">
				<select id="sWeekURL" class="form-control input-sm" size="1">
					<cfloop from="1" to="#arrayLen(rc.arWeeks)#" index="local.itm">
						<option value="#buildURL('week.setWeek')#&nWeekID=#rc.arWeeks[local.itm].getNWeekID()#"<cfif rc.oWeek.getNWeekID() eq rc.arWeeks[local.itm].getNWeekID()> selected="selected"</cfif>>
	...
	<div class="panel-body">
		...
		<cfif rc.bIsLocked>
			<div class="alert alert-warning">
				...
				<div class="input-group">
					<button id="overrideLock" class="btn btn-default btn-sm" data-url="#buildURL('week.setWeek')#&nWeekID=#rc.oWeek.getNWeekID()#&bOverrideLock=true">Override Lock</button>
				</div>
			</div>
		<cfelse>
...
<table id="defaultGame" class="hide">
	<tr class="game" data-game-id="">
		...
		<td><span title="Delete Game" class="fa fa-trash-o delete icons fa-fw fa-lg"></span> <span title="Swap HOME/Away Teams" class="fa fa-exchange swap icons fa-lg"></span></td>
	<tr>
</table>