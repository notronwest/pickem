<div class="panel panel-default">
	...
	<div class="panel-body">
		<cfif compareNoCase("pickem", request.sLeagueKey) eq 0>
			...
			<p>
				The fee for the league will be $30 with over 95% of that fee going back into the prize pool, while less than 5% going to the hosting and maintenance of the site. Payment of the $30 can be sent to me the following ways:
			</p>
			<p>
