					...
					<cfloop from="1" to="#arrayLen(rc.arWeeks)#" index="itm">
						<cfoutput><tr data-id="#rc.arWeeks[itm].getNWeekID()#">
							...
							<td class="week-actions">
								<span class="fa fa-edit edit icons fa-fw fa-lg">&nbsp;</span><span class="fa fa-trash-o delete icons fa-fw fa-lg">&nbsp;</span> [#rc.arWeeks[itm].getNWeekID()#]  (<a href="#buildURL('week.setWeekGames')#&nWeekID=#rc.arWeeks[itm].getNWeekID()#">Games</a> - <a href="#buildURL('standing.calculate')#&nWeekID=#rc.arWeeks[itm].getNWeekID()#">Standings</a> - <a href="#buildURL('week.makeAutoPicks')#&nWeekID=#rc.arWeeks[itm].getNWeekID()#">Auto Picks</a>)
							</td>
						</tr></cfoutput>
					</cfloop>
				</tbody>
