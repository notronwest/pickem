<nav class="navbar navbar-default">
  <div class="container-fluid container">
      ...
      <cfoutput><a class="navbar-brand" href="#buildURL('pickem:standing.home')#">Pickem</a></cfoutput>
        ...
        <ul class="nav navbar-nav" id="menu">
          <cfoutput>
            <li<cfif compareNoCase(listFirst(request.action, "."), "standing") eq 0 and not rc.bIsAdminAction> class="active"</cfif>>
              <a href="#buildURL('pickem:pickem:standing.home')#"><span class="fa fa-list-ol fa-fw"></span> Standings</a>
            </li>
      			<li<cfif compareNoCase(listFirst(request.action, "."), "pick") eq 0 and not rc.bIsAdminAction> class="active"</cfif>>
              <a href="#buildURL('pickem:pick.set')#"><span class="fa fa-crosshairs fa-fw"></span> Picks</a>
            </li>
            <li<cfif compareNoCase(listFirst(request.action, "."), "user") eq 0 and not rc.bIsAdminAction> class="active"</cfif>>
              <a href="#buildURL('pickem:user.addEdit')#"><span class="fa fa-user fa-fw"></span>Account</a>
            </li>
            <li<cfif compareNoCase(listFirst(request.action, "."), "seasonPayout") eq 0> class="active"</cfif>>
              <a href="#buildURL('pickem:seasonPayout.details')#"><span class="fa fa-dollar fa-fw"></span>Payouts</a>
            </li>
              ...
              <li<cfif compareNoCase(listLast(request.action, "."), "admin") eq 0 or rc.bIsAdminAction> class="active"</cfif>>
                <a href="#buildURL('pickem:main.admin')#"><span class="fa fa-cubes fa-fw"></span> Admin</a>
              </li>
            </cfif>
            <li>
